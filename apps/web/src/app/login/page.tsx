...
import { Activity, ShieldCheck, Workflow, ScanSearch, UserCheck } from "lucide-react";
      ...
      <div className="hidden relative bg-blue-600 lg:block overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-12 text-white">
          <Link href="/" className="flex items-center gap-2.5 font-black text-2xl tracking-tight group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-xl text-blue-600 group-hover:scale-105 transition-transform text-xl">
          ...
          <div className="max-w-md">
            ...
            <h2 className="text-4xl font-black leading-tight mb-8">
              혼자서도 완벽한<br />
              <span className="text-blue-100 underline decoration-blue-400 decoration-4 underline-offset-8">주문 관리 자동화</span>
            </h2>
            <p className="text-lg text-blue-50/80 mb-12 leading-relaxed font-bold">
              AI 파싱 시스템이 당신의 비서가 되어드립니다. 
              작은 팀도 대형 기업 수준의 효율적인 유통 프로세스를 갖출 수 있습니다.
            </p>

            <div className="grid gap-6">
              {[
                { icon: <ScanSearch className="h-5 w-5" />, text: "지능형 메시지 자동 주문 분석" },
                { icon: <Workflow className="h-5 w-5" />, text: "1인 기업을 위한 업무 자동화 파이프라인" },
                { icon: <ShieldCheck className="h-5 w-5" />, text: "식약처 API 연동 및 전문 데이터 관리" },
              ].map((item, i) => (
          ...
          <div className="text-xs font-bold text-blue-200 uppercase tracking-widest">
            &copy; 2026 NotiFlow. Empowering Small Teams.
          </div>
        </div>
      ...
      <div className="flex items-center justify-center p-8 lg:p-12 relative bg-white">
        ...
        <div className="w-full max-w-[420px] space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div className="flex flex-col items-center text-center space-y-4">
             ...
             <h1 className="text-4xl font-black tracking-tight text-zinc-900">관리자 로그인</h1>
             <p className="text-zinc-500 font-bold">
               소규모 비즈니스의 성장을 위한 대시보드
             </p>
          </div>
          ...
          <div className="space-y-6 text-center">
            <p className="text-sm text-zinc-500 font-bold">
              계정이 필요하시면 <span className="text-blue-600 font-black">NotiFlow 지원팀</span>에 문의하세요.
            </p>
