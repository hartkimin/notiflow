...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      { title: "주문 상태 흐름", description: "초안(draft) → 접수확인(confirmed) → 배송완료(delivered) → 정산완료(invoiced)\n각 단계에서 상태 변경 버튼을 클릭하여 진행합니다." },
      ...
      { title: "세금계산서", description: "배송완료 상태의 주문에서 '세금계산서 발행' 버튼으로 생성합니다. 발행된 계산서는 PDF로 다운로드할 수 있습니다." },
    ],
  },
  {
    id: "sales",
